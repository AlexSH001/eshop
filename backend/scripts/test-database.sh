...
HEALTH_RESPONSE=$(curl -s https://fortunewhisper.com/backend/api/monitoring/health || echo "FAILED")
...
DB_RESPONSE=$(curl -s https://fortunewhisper.com/backend/api/monitoring/metrics || echo "FAILED")
