...
- **API**: http://10.170.0.4:3001/api
- **Health Check**: http://10.170.0.4:3001/api/monitoring/health
- **Metrics**: http://10.170.0.4:3001/api/monitoring/metrics
...
```yaml
healthcheck:
  test: ["CMD", "curl", "-f", "http://10.170.0.4:3001/api/monitoring/health"]
  interval: 30s
  timeout: 10s
  retries: 3
  start_period: 40s
