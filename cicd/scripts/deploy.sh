...
check_health() {
    ...
    if curl -f https://fortunewhisper.com/backend/api/health > /dev/null 2>&1; then
    ...
    if curl -f https://fortunewhisper.com > /dev/null 2>&1; then
...
show_status() {
    ...
    echo "  Backend API: https://fortunewhisper.com/backend/api"
