...
export default function AdminUsersPage() {
  ...
  const fetchUsers = async () => {
    ...
    try {
      ...
      const res = await fetch('http://10.170.0.4:3001/api/admin/users/authenticated', {
        headers: {
  ...
  const handleAddUser = async () => {
    ...
    try {
      ...
      const res = await fetch('http://10.170.0.4:3001/api/users', {
        method: 'POST',
        headers: { 
          'Authorization': `Bearer ${adminToken}`,
          'Content-Type': 'application/json' 
  ...
  const handleEditUser = async () => {
    ...
    try {
      ...
      const res = await fetch(`http://10.170.0.4:3001/api/users/${editingUser.id}`, {
        method: 'PUT',
        headers: { 
          'Authorization': `Bearer ${adminToken}`,
          'Content-Type': 'application/json' 
  ...
  const handleDeleteUser = async () => {
    ...
    try {
      ...
      const res = await fetch(`http://10.170.0.4:3001/api/users/${deletingUser.id}`, {
        method: 'DELETE',
        headers: {
          'Authorization': `Bearer ${adminToken}`
        },
