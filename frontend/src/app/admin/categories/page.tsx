...
export default function AdminCategoriesPage() {
  ...
  const fetchCategories = async () => {
    ...
    try {
      ...
      const res = await fetch('http://backend:3001/api/categories/admin/list', {
        headers: {
  ...
  const handleEditCategory = async () => {
    ...
    try {
      ...
      const res = await fetch(`http://backend:3001/api/categories/${editingCategory.id}`, {
        method: 'PUT',
        headers: { 
          'Authorization': `Bearer ${adminToken}`,
          'Content-Type': 'application/json' 
  ...
  const handleDeleteCategory = async () => {
    ...
    try {
      ...
      const res = await fetch(`http://backend:3001/api/categories/${deletingCategory.id}`, {
        method: 'DELETE',
        headers: {
          'Authorization': `Bearer ${adminToken}`
        },
