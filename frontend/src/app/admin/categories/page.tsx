...
export default function AdminCategoriesPage() {
  ...
  const fetchCategories = async () => {
    ...
    try {
      ...
      const res = await fetch('https://10.170.0.4/api/categories/admin/list', {
        headers: {
  ...
  const handleEditCategory = async () => {
    ...
    try {
      ...
      const res = await fetch(`https://10.170.0.4/api/categories/${editingCategory.id}`, {
        method: 'PUT',
        headers: { 
          'Authorization': `Bearer ${adminToken}`,
          'Content-Type': 'application/json' 
  ...
  const handleDeleteCategory = async () => {
    ...
    try {
      ...
      const res = await fetch(`https://10.170.0.4/api/categories/${deletingCategory.id}`, {
        method: 'DELETE',
        headers: {
          'Authorization': `Bearer ${adminToken}`
        },
