...
export default function AdminCategoriesPage() {
  ...
  const fetchCategories = async () => {
    ...
    try {
      ...
      const res = await fetch('https://fortunewhisper.com/backend/api/categories/admin/list', {
        headers: {
  ...
  const handleEditCategory = async () => {
    ...
    try {
      ...
      const res = await fetch(`https://fortunewhisper.com/backend/api/categories/${editingCategory.id}`, {
        method: 'PUT',
        headers: { 
          'Authorization': `Bearer ${adminToken}`,
          'Content-Type': 'application/json' 
  ...
  const handleDeleteCategory = async () => {
    ...
    try {
      ...
      const res = await fetch(`https://fortunewhisper.com/backend/api/categories/${deletingCategory.id}`, {
        method: 'DELETE',
        headers: {
          'Authorization': `Bearer ${adminToken}`
        },
