  ...
  useEffect(() => {
    const loadFallbackProducts = async () => {
      try {
        ...
        setFallbackProducts(groupedProducts.Fashion || []);
      } catch (error) {
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="relative h-64 bg-gradient-to-r from-purple-500 to-pink-500">
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
          <h1 className="text-4xl font-bold text-white mb-4">Fashion Collection</h1>
          <p className="text-xl text-white/90">Discover the latest trends in clothing, shoes, and accessories</p>
        </div>
      </div>
