...
export default function AutomotivePage() {
  ...
  useEffect(() => {
    const loadFallbackProducts = async () => {
      try {
        ...
        setFallbackProducts(groupedProducts.Automotive || []);
      } catch (error) {
  ...
  const { products = [], isLoading, error } = useCategoryProducts('Automotive', fallbackProducts);
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="relative h-64 bg-gradient-to-r from-red-600 to-orange-600">
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
          <h1 className="text-4xl font-bold text-white mb-4">Automotive</h1>
          <p className="text-xl text-white/90">Car parts, accessories, and tools for your vehicle</p>
        </div>
      </div>
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="mb-8 flex items-center justify-between">
          <div>
            <h2 className="text-2xl font-bold text-gray-900">Automotive Products</h2>
        ...
        {!isLoading && (products || []).length === 0 && (
          <div className="text-center py-12">
            <div className="mx-auto max-w-md">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">No Automotive Products Yet</h3>
              <p className="text-gray-600 mb-6">
                We're working on adding amazing car parts, accessories, and tools. Check back soon!
              </p>
