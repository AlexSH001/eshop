...
export default function PhotographyPage() {
  ...
  useEffect(() => {
    const loadFallbackProducts = async () => {
      try {
        ...
        setFallbackProducts(groupedProducts.Photography || []);
      } catch (error) {
  ...
  const { products = [], isLoading, error } = useCategoryProducts('Photography', fallbackProducts);
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="relative h-64 bg-gradient-to-r from-purple-600 to-pink-600">
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-white/90">Capture the perfect moment with professional photography equipment</p>
        </div>
      </div>
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="mb-8 flex items-center justify-between">
          <div>
            <h2 className="text-2xl font-bold text-gray-900">Photography Products</h2>
        ...
        {!isLoading && (products || []).length === 0 && (
          <div className="text-center py-12">
            <div className="mx-auto max-w-md">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">No Photography Products Yet</h3>
              <p className="text-gray-600 mb-6">
                We're working on adding amazing photography equipment and accessories. Check back soon!
              </p>
