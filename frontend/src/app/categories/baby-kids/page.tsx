...
export default function BabyKidsPage() {
  ...
  useEffect(() => {
    const loadFallbackProducts = async () => {
      try {
        ...
        setFallbackProducts(groupedProducts['Baby & Kids'] || []);
      } catch (error) {
  ...
  const { products = [], isLoading, error } = useCategoryProducts('Baby & Kids', fallbackProducts);
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="border-b border-gray-100 bg-gray-50">
        <div className="mx-auto max-w-7xl px-4 py-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-400">/</span>
            <span className="font-medium text-gray-900">Baby & Kids</span>
          </div>
        </div>
      </div>

      {/* Hero Section */}
      <div className="relative h-64 bg-gradient-to-r from-pink-600 to-purple-600">
        <div className="absolute inset-0 bg-black/20" />
        <div className="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
          <h1 className="text-4xl font-bold text-white mb-4">Baby & Kids</h1>
          <p className="text-xl text-white/90">Toys, clothes, and safety products for children</p>
        </div>
      </div>
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="mb-8 flex items-center justify-between">
          <div>
            <h2 className="text-2xl font-bold text-gray-900">Baby & Kids Products</h2>
        ...
        {!isLoading && (products || []).length === 0 && (
          <div className="text-center py-12">
            <div className="mx-auto max-w-md">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">No Baby & Kids Products Yet</h3>
              <p className="text-gray-600 mb-6">
                We're working on adding amazing toys, clothes, and safety products for children. Check back soon!
              </p>
